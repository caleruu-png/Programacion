...
public class Gestion {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nApartado f)");
		String[] comidasCadiz = {"Puchero", "Caldereta", "Choco Frito", "Tortilla"};
		CiudadGastronómica cadiz=new CiudadGastronómica("Cadiz", 451658915, comidasCadiz);
		cadiz.addComida("Pato");
		listaRutas.addRuta(new Ruta(sevilla,cadiz,50));
